...
Если Pages уже включен на ветке с каталогом `docs/`, страницы будут доступны по адресу GitHub Pages вашего репозитория. Локально можно читать файлы `.md` напрямую в GitHub/IDE.
